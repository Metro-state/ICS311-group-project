ALTER TABLE `song_keywords` ADD CONSTRAINT `delete_cascade_to_song_keywords` FOREIGN KEY (`song_id`) REFERENCES `song_keywords`(`song_id`) ON DELETE CASCADE ON UPDATE CASCADE;
